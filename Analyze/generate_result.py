...
class generater:
    ...
    def __init__(self, path, save_path):
        ...
        with open("./../file_list.txt", "w", encoding="utf-8") as f:
            for file in self.filelist:
                f.write(file + "\n")
        self.total_mem = {"A100":'40,960 MiB',"4090":'24,564 MiB',"Jetson-Xanier-NX":'6,833 MiB',"MR-100":'32,768 MiB',"BI-150":'32,768 MiB',"MLU370-M8":'42,396 MiB',"910B":'65,536MiB',"910A":'32,768MiB',"M2-Ultra":'196,608MiB'}
    ...
    def show_items(self):
        # 构建字典
        train_items_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        infer_items_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        print("showing items...")
    ...
    def show_table(self):
        ...
        if not os.path.exists(save_path):
            os.makedirs(save_path)
        # 构建吞吐量的字典
        train_throughput_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        infer_throughput_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        # 构建平均功率的字典
        train_power_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        infer_power_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        # 构建能效比的字典
        train_energy_efficiency_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}  
        infer_energy_efficiency_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        # 构建GPU利用率的字典
        train_GPU_Utilization_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        infer_GPU_Utilization_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        # 构建显存利用率的字典
        train_Memory_Utilization_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        infer_Memory_Utilization_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        # 构建平均温度的字典
        train_average_temperature_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        infer_average_temperature_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        # 构建平均前向推理时延的字典
        infer_average_inference_delay_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        ...
        # 为每种device绘制表格(包括train和infer的各个参数)
        for device in train_throughput_dict.keys():
            # train
            train_table = pd.DataFrame()
            train_table["Model"] = train_throughput_dict[device].keys()
            train_table["Throughput(Items/s)"] = train_throughput_dict[device].values()
            train_table["Power(W)"] = train_power_dict[device].values()
            train_table["Energy Efficiency(Items/W)"] = train_energy_efficiency_dict[device].values()
            train_table["GPU Utilization(%)"] = train_GPU_Utilization_dict[device].values()
            train_table["Memory Utilization(%)"] = train_Memory_Utilization_dict[device].values()
            train_table["Average Temperature(C)"] = train_average_temperature_dict[device].values()
            # infer
            infer_table = pd.DataFrame()
            infer_table["Model"] = infer_throughput_dict[device].keys()
            infer_table["Throughput(Items/s)"] = infer_throughput_dict[device].values()
            infer_table["Power(W)"] = infer_power_dict[device].values()
            infer_table["Energy Efficiency(Items/W)"] = infer_energy_efficiency_dict[device].values()
            infer_table["GPU Utilization(%)"] = infer_GPU_Utilization_dict[device].values()
            infer_table["Memory Utilization(%)"] = infer_Memory_Utilization_dict[device].values()
            infer_table["Average Temperature(C)"] = infer_average_temperature_dict[device].values()
            infer_table["Average Inference Delay(s)"] = infer_average_inference_delay_dict[device].values()
            # 保存为csv文件
            # 如果路径不存在，就创建
            if not os.path.exists(save_path + "/devices/" + device):
                os.makedirs(save_path + "/devices/" + device)
            train_table.to_csv(save_path + "/devices/" + device + "/train_table.csv")
            infer_table.to_csv(save_path + "/devices/" + device + "/infer_table.csv")
    ...
    def show_diagram(self):
        ...
        time_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        GPU_Utilization_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        Temperature_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
        Power_dict = {"4090":{}, "A100":{}, "BI-150":{}, "MR-100":{}, "910B":{}, "M2-Ultra":{}}
